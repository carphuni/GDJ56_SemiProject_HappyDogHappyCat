...
/**
 * Servlet implementation class QaCommentListServlet
 */
@WebServlet("/qa/qaCommentList.do")
public class QaCommentListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QaCommentListServlet() {
        super();
