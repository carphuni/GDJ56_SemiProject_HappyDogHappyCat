...
/**
 * Servlet implementation class AdoptReviewSearchServlet
 */
@WebServlet("/adopt/adoptreviewsearch")
public class AdoptReviewSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdoptReviewSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<AdtReviewBorad> rList=new AdoptService().adoptReviewSearch(cPage,numPerpage,keyword);
		
		int totalData=new AdoptService().adoptReviewSearchCount(keyword);
