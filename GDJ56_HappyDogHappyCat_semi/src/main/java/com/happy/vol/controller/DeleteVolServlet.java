...
/**
 * Servlet implementation class DeleteVolServlet
 */
@WebServlet("/deletevol.do")
public class DeleteVolServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new VolunteerService().deleteVolunteer(boardNo);
		request.setAttribute("msg", result>0?"게시물이 삭제되었습니다":"삭제 실패");
		request.setAttribute("loc", "/volview.do");
